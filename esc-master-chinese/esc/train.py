...
from esc.esc_dataset import WordNetDataset, OxfordDictionaryDataset, DatasetAlternator,ChineseDataset,MultiChineseDataset
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--validation_path", default="data/chinese_ours/val/val.data.txt"
    )
    ...
    parser.add_argument(
        "--chinese_dic",default="data/chinese_ours/wsd_single_sense_final.json"
    )
