...
from esc.esc_dataset import WordNetDataset, OxfordDictionaryDataset,ChineseDataset,MultiChineseDataset
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--chinese_dic",default="data/chinese_ours/wsd_single_sense_final.json")    
...
def main() -> None:
    ...
    for prediction_type in args.prediction_types:
        ...
        for dataset_path in dataset_paths:
            ...
            dataset_path = dataset_path.replace(".data.txt", "").replace(".gold.key.txt", "")
            ...
            if args.oxford_test:
                ...
                dataset = MultiChineseDataset(
                    dataset_path, tokenizer, args.tokens_per_batch, re_init_on_iter=False, is_test=True,dic_path=args.chinese_dic
                )
